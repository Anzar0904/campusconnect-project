...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[90vh] lg:min-h-screen w-full overflow-hidden bg-[#09090B] pt-24 pb-16 lg:pt-36 lg:pb-24 px-4 sm:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center z-10">
      {/* Background Gradients & Ambient Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(59,130,246,0.03),transparent_50%)] pointer-events-none" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_70%,rgba(34,197,94,0.015),transparent_50%)] pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.02)_0%,transparent_70%)] pointer-events-none" />
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="lg:col-span-5 flex flex-col justify-center space-y-6 z-10 text-center lg:text-left"
      >
        <motion.div 
      ...
      <div className="lg:col-span-7 relative flex flex-col items-center justify-center w-full min-h-[420px] sm:min-h-[500px] lg:min-h-[660px] z-10 select-none overflow-visible">
        ...
        <div className="w-full lg:absolute lg:inset-0 flex flex-wrap lg:block justify-center gap-4 mt-8 lg:mt-0 z-20">
          ...
          <motion.div 
            ...
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:top-4 lg:left-[-20px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
          ...
          <motion.div 
            ...
            transition={{ 
              ...
              x: { duration: 7, repeat: Infinity, ease: "easeInOut", delay: 0.3 },
              opacity: { duration: 0.5 }
            }}
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:top-12 lg:right-[-20px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
            <div className="flex items-center gap-2 mb-0.5">
          ...
          <motion.div 
            ...
            transition={{ 
              ...
              x: { duration: 6.5, repeat: Infinity, ease: "easeInOut", delay: 0.6 },
              opacity: { duration: 0.5 }
            }}
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:top-[38%] lg:left-[-70px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
            <div className="flex items-center gap-2 mb-0.5">
          ...
          <motion.div 
            ...
            transition={{ 
              y: { duration: 8, repeat: Infinity, ease: "easeInOut", delay: 0.9 },
              x: { duration: 8, repeat: Infinity, ease: "easeInOut", delay: 0.9 },
              opacity: { duration: 0.5 }
            }}
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:bottom-6 lg:left-[-20px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
            <div className="flex items-center gap-2 mb-0.5">
          ...
          <motion.div 
            ...
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:bottom-8 lg:right-[-20px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
            <div className="flex items-center gap-2 mb-0.5">
              <div className="w-5 h-5 rounded-md bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400">
                <Briefcase size={11} />
          ...
          <motion.div 
            ...
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:top-[42%] lg:right-[-70px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
            <div className="flex items-center gap-2 mb-0.5">
              <div className="w-5 h-5 rounded-md bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400">
                <Calendar size={11} />
          ...
          <motion.div 
            ...
            transition={{ 
              y: { duration: 6.8, repeat: Infinity, ease: "easeInOut", delay: 0.8 },
              x: { duration: 6.8, repeat: Infinity, ease: "easeInOut", delay: 0.8 },
              opacity: { duration: 0.5 }
            }}
            className="w-[calc(50%-8px)] sm:w-[220px] lg:w-52 lg:absolute lg:top-[-25px] lg:left-[130px] bg-[#18181B]/85 backdrop-blur-md border border-white/[0.04] hover:border-white/[0.08] hover:bg-[#232329]/95 rounded-2xl p-4 transition-colors duration-300 shadow-[0_12px_30px_rgba(0,0,0,0.4)] flex flex-col gap-1.5"
          >
            <div className="flex items-center gap-2 mb-0.5">
              <div className="w-5 h-5 rounded-md bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400">
                <Award size={11} />
